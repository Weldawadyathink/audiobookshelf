...
class AbstractComicBookExtractor {
  ...
  async extractToFile(filePath: string, outputFilePath: string): Promise<boolean> {
    throw new Error('Not implemented')
  }

  async extractToBuffer(filePath: string): Promise<Buffer | null> {
    throw new Error('Not implemented')
  }
...
export function createComicBookExtractor(comicPath: string): AbstractComicBookExtractor {
