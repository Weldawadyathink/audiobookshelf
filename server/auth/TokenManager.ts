...
class TokenManager {
  ...
  static TokenSecret: string = null
   ...
   */
  setRefreshTokenCookie(req: any, res: any, refreshToken: string) {
   ...
   * @returns {string}
   */
  static generateAccessToken(user: { id: string; username: string }) {
   ...
   * @returns {string}
   */
  generateAccessToken(user: { id: string; username: string }) {
   ...
   * @returns {string}
   */
  generateTempAccessToken(user: { id: string; username: string }) {
    const payload = {
      userId: user.id,
   ...
   * @returns {string}
   */
  generateRefreshToken(user: { id: string; username: string }) {
    const payload = {
      userId: user.id,
      username: user.username,
      type: 'refresh'
   ...
   */
  async createTokensAndSession(user: { id: string; username: string }, req: any) {
   ...
   */
  async rotateTokensForSession(session: any, user: any, req: any, res: any) {
    // Generate new tokens
   ...
   */
  async jwtAuthCheck(jwt_payload: any, done: Function) {
   ...
   */
  async handleRefreshToken(refreshToken: string, req: any, res: any) {
    try {
   ...
   */
  async invalidateJwtSessionsForUser(user: any, req: any, res: any) {
