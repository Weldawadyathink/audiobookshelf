...
import LocalStrategy from '../libs/passportLocal'
...
class LocalAuthStrategy {
   ...
   */
  async verifyCredentials(req: any, username: string, password: string, done: Function) {
   ...
   */
  logFailedLoginAttempt(req: any, username: string, message: string) {
   ...
   */
  comparePassword(password: string, user: any) {
