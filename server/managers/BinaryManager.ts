...
;(BinaryManager as any).Binary = Binary // for testing
;(BinaryManager as any).ffbinaries = ffbinaries // for testing
;(BinaryManager as any).nunicode = nunicode // for testing
